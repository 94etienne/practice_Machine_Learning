...
# Streamlit app title
st.title("House Size Prediction App")
...
# Predict button
if st.button("Predict House Size"):
    ...
    with st.container():
        st.markdown(
            ...
            <div style="
                ...
                margin: auto;
            ">
                <h3 style="color: #333; margin-bottom: 10px;">Predicted House Size</h3>
                <h2 style="color: #0066cc; margin-top: 0;">{prediction}</h2>
            </div>
            """,
